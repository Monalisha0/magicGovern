...
public class CompanyLocator {
	...
	public By GetInTouchBtn = By.xpath("//span[text()='Get in touch']");
	public By WhyUsTabBtn = By.xpath("(//a[text()='Why us']//ancestor::li[@class='menu-item menu-item-type-post_type menu-item-object-page menu-item-987725'])[1]");
	public By ExploreOurServiceBtn = By.xpath("//span[text()='Explore our services']//ancestor::a[@href='https://www.magicgovern.ai/solutions/']");
	public By YouTubeBtn = By.xpath("//button[@title='Play']");
	public By Youtubeiframe = By.xpath("//iframe[@src='https://www.youtube.com/embed/ppawFI1u6Po?feature=oembed']");
	public By LeftVideoButton = By.xpath("//a[@class='elementor-icon']");
	public By BackToTeamMembersBtn = By.xpath("//span[text()='Back to Team Members']");
